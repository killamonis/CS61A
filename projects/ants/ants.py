...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while current_tile != beehive:
            if current_tile.bees and index >= self.min_range and index <= self.max_range:
                if self.basic_thrower or index != 4:
                    return random_or_none(current_tile.bees)
            else:
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.armor = armor
        self.doubled_ants = []
        if QueenAnt.queen_checker == 0:
            self.real_queen = True
        QueenAnt.queen_checker += 1
        # END Problem 13
    ...
    def remove_from(self, place):
        if isinstance(self, QueenAnt) and self.real_queen:
            return None
