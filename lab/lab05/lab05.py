...
def couple(lst1, lst2):
    ...
    for i in range(len(lst1)):
        couples = []
        couples.append(lst1[i])
        couples.append(lst2[i])
        retlist.append(couples)
    return retlist
...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    check_city = make_city('Check', lat, lon)
    min_distance = min(distance(check_city, city1), distance(check_city, city2))
    if min_distance == distance(check_city, city1):
